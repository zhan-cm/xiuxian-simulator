...
describe('ShowcaseNavigator', () => {
  it('persists checked pages and page notes', () => {
    render(<ShowcaseNavigator pages={pages} index={0} appVersion="0.60.0" onIndex={() => undefined} onExit={() => undefined} />)
  ...
  it('copies a privacy-safe acceptance summary', async () => {
    ...
    expect(writeText.mock.calls[0][0]).toContain('《问道长生》V0.60.0 玩家验收摘要')
