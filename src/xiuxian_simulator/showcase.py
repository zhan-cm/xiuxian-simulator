...
SHOWCASE_PAGES: tuple[tuple[str, str, str, list[str], PageSetup], ...] = (
    ("home", "洞府主界面", "查看游戏三栏结构、根基状态和自由行动入口。", ["核心事件应最醒目", "属性数值应一眼可读", "未开放行动需要灰化"], _ready),
    ...
    ("map", "九州舆图", "验证五域路线、区域商情、境界准入与真实地方机缘。", ["当前所在地、已踏访与机缘待决状态明确", "高境界地域自动锁定", "特产、求购和行程可快速比较"], _map),
    ...
    ("relations", "浮生故人", "验证人物独立档案、寿元、生平、护道抉择和关系路径。", ["每位故人都可打开独立档案", "年龄、境界与在世状态来自真实存档", "巡览中可看档案但交谈、论道与护道必须禁用"], _relations),
