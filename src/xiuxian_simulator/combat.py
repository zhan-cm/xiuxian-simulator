...
ENEMIES = {
    ...
    "赤背火蜥": EnemyTemplate("赤背火蜥", 1, 0, 210, 14, 39, 14, "火", {"妖兽材料": 2}, 70),
    "裂风妖虎": EnemyTemplate("裂风妖虎", 1, 3, 290, 21, 51, 18, "木", {"妖兽材料": 3}, 110),
    "化形妖将": EnemyTemplate("化形妖将", 2, 2, 430, 23, 70, 29, "土", {"天材地宝": 1}, 220),
    "沙海劫修": EnemyTemplate("沙海劫修", 3, 0, 520, 24, 84, 38, "金", {"神行符": 2}, 360),
    "石胎魔僧": EnemyTemplate("石胎魔僧", 3, 2, 620, 16, 94, 52, "土", {"天材地宝": 1}, 420),
    "噬魂魔影": EnemyTemplate("噬魂魔影", 4, 2, 780, 28, 118, 58, "水", {"道韵": 1}, 680),
    "寒甲冰熊": EnemyTemplate("寒甲冰熊", 5, 0, 920, 18, 135, 76, "水", {"冰莲": 2}, 760),
    "玄冰蛟": EnemyTemplate("玄冰蛟", 5, 2, 1080, 31, 158, 82, "水", {"五行灵珠": 1}, 980),
    "幽冥鬼王": EnemyTemplate("幽冥鬼王", 6, 1, 1320, 29, 188, 96, "土", {"道韵": 2}, 1400),
    "中州豪客": EnemyTemplate("中州豪客", 1, 2, 260, 18, 46, 19, "金", {"聚气丹": 2}, 150),
    "试剑傀儡": EnemyTemplate("试剑傀儡", 2, 1, 390, 20, 66, 31, "金", {"灵铁": 4}, 210),
    "阵灵化身": EnemyTemplate("阵灵化身", 3, 1, 580, 22, 90, 45, "木", {"五行灵珠": 1}, 380),
}
